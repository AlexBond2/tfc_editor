...
namespace Lzo64
{
  public class LZOCompressor
  {
    ...
    [DllImport("lzo2_64.dll")]
    private static extern int lzo1x_999_compress(
      byte[] src,
      int src_len,
      byte[] dst,
      ref int dst_len,
    ...
    private static extern int lzo1x_1_compress32(
      byte[] src,
      int src_len,
      byte[] dst,
      ref int dst_len,
    ...
    private static extern int lzo1x_decompress32(
      byte[] src,
      int src_len,
      byte[] dst,
      ref int dst_len,
    ...
    private static extern int __lzo_init_v2_32(
      uint v,
      int s1,
      int s2,
      int s3,
    ...
    public byte[] Compress(byte[] src)
    {
      ...
      Array.Copy((Array) buffer, 0, (Array) destinationArray, 0, dst_len);
